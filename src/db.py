...
CREATE TABLE IF NOT EXISTS butterfly_taxa (
    taxon_id    INTEGER PRIMARY KEY,
    taxon_name  TEXT,
    common_name TEXT,
    obs_count   INTEGER,
...
CREATE TABLE IF NOT EXISTS region_butterfly_taxa (
    taxon_id     INTEGER PRIMARY KEY,
    taxon_name   TEXT,
    common_name  TEXT,
...
-- regional reference pool than the county alone.
CREATE TABLE IF NOT EXISTS region_moth_taxa (
    taxon_id     INTEGER PRIMARY KEY,
    taxon_name   TEXT,
    common_name  TEXT,
    region_count INTEGER,
...
CREATE TABLE IF NOT EXISTS region_amphibian_taxa (
    taxon_id     INTEGER PRIMARY KEY,
    taxon_name   TEXT,
    common_name  TEXT,
    region_count INTEGER,
